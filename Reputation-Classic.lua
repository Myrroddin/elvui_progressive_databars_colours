...
local function UpdateReputation()
	...
	if not name or not reaction or not currentReactionThreshold or not nextReactionThreshold or not currentStanding then return end -- exit if we don't have a faction
